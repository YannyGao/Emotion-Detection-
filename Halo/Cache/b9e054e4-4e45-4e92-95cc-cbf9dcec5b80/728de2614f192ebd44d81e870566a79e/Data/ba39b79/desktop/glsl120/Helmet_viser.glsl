...
#if (Tweak_N354)
{
vec3 l9_0=Globals.VertexTangent_WorldSpace;
vec3 l9_1=Globals.VertexBinormal_WorldSpace;
vec3 l9_2=Globals.VertexNormal_WorldSpace;
vec2 param_6;
Node208_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),param_6,Globals);
float l9_3=param_6.x;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_4=l9_3;
float l9_5=param_6.y;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_6=l9_5;
vec2 l9_7;
float l9_8;
...
{
l9_9=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_9=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_10=l9_4;
float l9_11=1.0;
sc_ClampUV(l9_10,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_9,l9_11);
float l9_12=l9_10;
float l9_13=l9_11;
bool l9_14;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_14=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_14=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_15=l9_6;
float l9_16=l9_13;
sc_ClampUV(l9_15,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_14,l9_16);
l9_8=l9_16;
...
#endif
vec2 l9_17=sc_TransformUV(l9_7,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_18=l9_17.x;
float l9_19=l9_8;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_19);
float l9_20=l9_17.y;
float l9_21=l9_19;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0)),l9_21);
float l9_22=l9_21;
vec3 l9_23=sc_SamplingCoordsViewToGlobal(vec2(l9_18,l9_20),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_24=texture2D(normalTex,l9_23.xy,0.0);
vec4 l9_25;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_25=mix(normalTexBorderColor,l9_24,vec4(l9_22));
}
#else
{
l9_25=l9_24;
...
#endif
vec3 param_11;
Node113_If_else(0.0,vec3(0.0),Port_Default_N113,param_11,Globals);
vec3 param_14;
Node345_Normalize(mat3(l9_0,l9_1,l9_2)*ngs_CombineNormals(l9_25.xyz,Port_Strength1_N200,param_11,Port_Strength2_N200),param_14,Globals);
Value1=param_14;
Result=Value1;
}
#else
{
vec3 param_17;
Node346_Normalize(Globals.VertexNormal_WorldSpace,param_17,Globals);
Default=param_17;
Result=Default;
}
#endif
