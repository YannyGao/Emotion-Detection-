...
if (pickUV==3)
{
l9_5=tempGlobals.N7_TransformedUV2;
}
else
{
l9_5=l9_4;
...
if (animated)
{
l9_10=l9_9+(offset*tempGlobals.gTimeElapsed);
}
else
{
l9_10=l9_9;
...
vec2 l9_6=gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw;
tempGlobals=ssGlobals(l9_1,l9_2,0.0,vec2(0.0),vec2(0.0),vec3(0.0),l9_3,varPos,varPos,l9_4,l9_5,cross(l9_4,l9_5)*varTangent.w,varPackedTex.xy,varPackedTex.zw,varColor,sc_ScreenCoordsGlobalToView(l9_6));
tempGlobals.N7_TransformedUV2=N7_gettransformUV(NODE_13_DROPLIST_ITEM,uv2Scale,uv2Offset,(int(uv2EnableAnimation)!=0),(int(ENABLE_UV2)!=0));
...
{
vec3 l9_147=tempGlobals.SurfacePosition_WorldSpace;
vec3 l9_148=reflect(normalize(sc_Camera.position-l9_147),l9_64);
...
#endif
l9_208=N7_vec3srgbToLinear(l9_207*l9_233.xyz);
}
#else
{
l9_208=l9_207;
...
#endif
vec3 l9_234=tempGlobals.SurfacePosition_WorldSpace;
float l9_235=dot(l9_64,normalize(sc_Camera.position-l9_234));
...
SurfaceProperties l9_284=SurfaceProperties(l9_283,l9_270,l9_278,varPos,l9_3,l9_273,l9_274,l9_279,l9_280,l9_276,vec3(1.0),l9_282);
...
{
LightingComponents l9_305=accumulateLight(LightingComponents(l9_293,l9_294,l9_299,l9_298,l9_296,l9_295),LightProperties(sc_DirectionalLights[l9_304].direction,sc_DirectionalLights[l9_304].color.xyz,sc_DirectionalLights[l9_304].color.w*l9_285[(l9_297<3) ? l9_297 : 3]),l9_284,l9_3);
...
vec2 l9_373=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_278,reflect(-l9_3,l9_278),l9_274),sc_EnvmapRotation.y);
vec4 l9_374;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
l9_371=vec3(0.0)+((((l9_374.xyz*(1.0/l9_374.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_284,abs(dot(l9_278,l9_3))));
}
#else
{
l9_371=vec3(0.0);
...
vec3 l9_382=reflect(-l9_3,l9_278);
float l9_383=dot(l9_278,l9_3);
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_441=sc_ScreenCoordsGlobalToView(l9_6);
...
#if (sc_OITCompositingPass)
{
vec2 l9_454=sc_ScreenCoordsGlobalToView(l9_6);
#if (sc_OITMaxLayers4Plus1)
{
...
#if (sc_OITFrontLayerPass)
{
if (abs(gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,sc_ScreenCoordsGlobalToView(l9_6)).x)>getFrontLayerZTestEpsilon())
{
discard;
}
