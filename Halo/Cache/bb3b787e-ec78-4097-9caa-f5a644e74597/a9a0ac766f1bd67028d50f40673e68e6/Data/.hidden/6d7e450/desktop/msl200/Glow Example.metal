...
//float4 Port_FinalColor_N004 4272
//float4 Port_Value_N000 4288
//float depthRef 4304
//}
...
//spec_const bool sc_ProxyAlphaOne 59 0
//spec_const bool sc_RenderAlphaToColor 60 0
//spec_const bool sc_ScreenTextureHasSwappedViews 61 0
//spec_const bool sc_ShaderComplexityAnalyzer 62 0
//spec_const bool sc_TAAEnabled 63 0
//spec_const bool sc_UseFramebufferFetchMarker 64 0
...
float4 FinalColor1=float4(0.360006,0.2,1.0,1.0);
bool l9_0=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_0)
{
...
Output_N0=(*sc_set0.UserUniforms).Port_Value_N000;
FinalColor1=Output_N0;
...
float4 param_4=FinalColor1;
out.FragColor1=param_4;
