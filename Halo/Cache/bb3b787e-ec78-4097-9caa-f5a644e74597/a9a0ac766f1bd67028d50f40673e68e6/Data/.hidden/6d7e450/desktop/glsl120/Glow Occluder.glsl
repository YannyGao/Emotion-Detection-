...
//spec_const bool sc_DepthOnly 53 0
...
uniform vec4 Port_FinalColor1_N004;
uniform int PreviewEnabled;
...
vec4 l9_32=max(Port_FinalColor1_N004,vec4(0.0));
sc_writeFragData1(l9_32);
vec4 l9_33=outputMotionVectorsIfNeeded(varPos,max(l9_31,vec4(0.0))+(l9_32*1e-06));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_35-0.0039215689)),min(1.0,l9_35+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_37),packValue(l9_37),packValue(l9_37),packValue(l9_37)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
if (l9_54==0)
{
l9_57=texture2D(sc_OITAlpha0,l9_49);
l9_56=texture2D(sc_OITDepthLow0,l9_49);
l9_55=texture2D(sc_OITDepthHigh0,l9_49);
}
else
{
l9_57=vec4(0.0);
...
if (l9_54==1)
{
l9_60=texture2D(sc_OITAlpha1,l9_49);
l9_59=texture2D(sc_OITDepthLow1,l9_49);
l9_58=texture2D(sc_OITDepthHigh1,l9_49);
}
else
{
l9_60=l9_57;
...
vec4 l9_75=texture2D(sc_OITFilteredDepthBoundsTexture,l9_49);
vec2 l9_76=l9_75.xy;
int l9_77;
#if (sc_SkinBonesCount>0)
{
