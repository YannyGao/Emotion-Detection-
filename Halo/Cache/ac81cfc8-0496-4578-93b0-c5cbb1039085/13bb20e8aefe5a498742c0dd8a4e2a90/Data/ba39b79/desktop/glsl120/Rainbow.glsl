...
//spec_const bool SC_USE_UV_TRANSFORM_opacityTex 37
//spec_const bool Tweak_N9 38
//spec_const bool UseViewSpaceDepthVariant 39
//spec_const bool intensityTextureHasSwappedViews 40
//spec_const bool opacityTexHasSwappedViews 41
...
//spec_const bool sc_BlendMode_Software 57
//spec_const bool sc_DepthOnly 58
//spec_const bool sc_FramebufferFetch 59
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 60
//spec_const bool sc_IsEditor 61
...
//spec_const bool sc_OITDepthPrepass 66
//spec_const bool sc_OITFrontLayerPass 67
//spec_const bool sc_OITMaxLayers4Plus1 68
//spec_const bool sc_OITMaxLayers8 69
//spec_const bool sc_OITMaxLayersVisualizeLayerCount 70
//spec_const bool sc_ProjectiveShadowsCaster 71
//spec_const bool sc_ProjectiveShadowsReceiver 72
...
//spec_const int NODE_7_DROPLIST_ITEM 80
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 81
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 82
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 83
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 84
//spec_const int intensityTextureLayout 85
//spec_const int opacityTexLayout 86
//spec_const int sc_DepthBufferMode 87
//spec_const int sc_RenderingSpace 88
//spec_const int sc_ScreenTextureLayout 89
//spec_const int sc_ShaderCacheConstant 90
//spec_const int sc_SkinBonesCount 91
//spec_const int sc_StereoRenderingMode 92
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 93
//spec_const int sc_StereoViewID 94
//SG_REFLECTION_END
...
ssGlobals l9_3=ssGlobals(l9_1,l9_2,0.0,(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz,varPackedTex.xy);
vec4 l9_4;
#if (Tweak_N9)
{
vec2 l9_5;
Node24_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),Port_Default_N024,l9_5,l9_3);
vec2 l9_6;
Node48_Rotate_Coords(l9_5,rotationAngle,Port_Center_N048,l9_6,l9_3);
vec3 l9_7=ssHSV_to_RGB(vec4(((l9_6*vec2(size*Port_Input1_N011))+vec2(l9_1*speed)).x,1.0,1.0,1.0).xyz);
vec4 l9_8=vec4(l9_7,1.0);
int l9_9;
...
sc_SoftwareWrapEarly(l9_10,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_11=l9_10;
float l9_12=varPackedTex.y;
sc_SoftwareWrapEarly(l9_12,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_13=l9_12;
vec2 l9_14;
float l9_15;
...
{
l9_16=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_16=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_17=l9_11;
float l9_18=1.0;
sc_ClampUV(l9_17,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_16,l9_18);
float l9_19=l9_17;
float l9_20=l9_18;
bool l9_21;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_21=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_21=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_22=l9_13;
float l9_23=l9_20;
sc_ClampUV(l9_22,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_21,l9_23);
l9_15=l9_23;
...
#endif
vec2 l9_24=sc_TransformUV(l9_14,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_25=l9_24.x;
float l9_26=l9_15;
sc_SoftwareWrapLate(l9_25,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_26);
float l9_27=l9_24.y;
float l9_28=l9_26;
sc_SoftwareWrapLate(l9_27,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_28);
float l9_29=l9_28;
vec3 l9_30=sc_SamplingCoordsViewToGlobal(vec2(l9_25,l9_27),opacityTexLayout,l9_9);
vec4 l9_31=texture2D(opacityTex,l9_30.xy,0.0);
vec4 l9_32;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_32=mix(opacityTexBorderColor,l9_31,vec4(l9_29));
}
#else
{
l9_32=l9_31;
...
#endif
vec4 l9_33=vec4(l9_8.x,l9_8.y,l9_8.z,vec4(0.0).w);
l9_33.w=l9_32.x;
l9_4=l9_33;
}
#else
{
vec2 l9_34;
Node24_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),Port_Default_N024,l9_34,l9_3);
vec2 l9_35;
Node48_Rotate_Coords(l9_34,rotationAngle,Port_Center_N048,l9_35,l9_3);
l9_4=vec4(ssHSV_to_RGB(vec4(((l9_35*vec2(size*Port_Input1_N011))+vec2(l9_1*speed)).x,1.0,1.0,1.0).xyz),1.0);
}
#endif
...
{
l9_38=clamp(l9_4.w*2.0,0.0,1.0);
}
#else
{
float l9_39;
...
{
l9_39=clamp(dot(l9_4.xyz,vec3(l9_4.w)),0.0,1.0);
}
#else
{
float l9_40;
...
{
l9_41=(1.0-dot(l9_4.xyz,vec3(0.33333001)))*l9_4.w;
}
#else
{
float l9_42;
...
{
l9_42=(1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0))*l9_4.w;
}
#else
{
float l9_43;
...
{
l9_43=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_4.w;
}
#else
{
float l9_44;
#if (sc_BlendMode_Add)
{
l9_44=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_45;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_45=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_4.w;
}
#else
{
float l9_46;
...
{
l9_46=dot(l9_4.xyz,vec3(0.33333001))*l9_4.w;
}
#else
{
float l9_47;
#if (sc_BlendMode_Min)
{
l9_47=1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_48;
#if (sc_BlendMode_Max)
{
l9_48=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_48=1.0;
...
#endif
l9_36=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_4.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_37);
}
#else
{
vec4 l9_49;
...
#endif
vec3 l9_59=mix(l9_57.xyz,definedBlend(l9_57.xyz,l9_4.xyz).xyz,vec3(l9_4.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_61=vec4(mix(vec3(1.0),l9_4.xyz,vec3(l9_4.w)),l9_4.w);
}
#else
{
vec4 l9_62;
...
#endif
l9_62=vec4(l9_4.xyz*l9_63,l9_63);
}
#else
{
l9_62=l9_4;
