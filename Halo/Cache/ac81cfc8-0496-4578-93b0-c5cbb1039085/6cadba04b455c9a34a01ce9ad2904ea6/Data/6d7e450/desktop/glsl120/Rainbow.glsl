...
//sampler sampler opacityTexSmpSC 0:17
...
//texture texture2D opacityTex 0:1:0:17
...
//spec_const bool SC_USE_UV_TRANSFORM_opacityTex 37 0
//spec_const bool Tweak_N9 38 0
//spec_const bool UseViewSpaceDepthVariant 39 1
//spec_const bool intensityTextureHasSwappedViews 40 0
//spec_const bool opacityTexHasSwappedViews 41 0
...
//spec_const bool sc_ShaderComplexityAnalyzer 75 0
//spec_const bool sc_TAAEnabled 76 0
//spec_const bool sc_UseFramebufferFetchMarker 77 0
//spec_const bool sc_VertexBlending 78 0
//spec_const bool sc_VertexBlendingUseNormals 79 0
//spec_const int NODE_7_DROPLIST_ITEM 80 0
...
//spec_const int opacityTexLayout 86 0
...
uniform float size;
uniform float speed;
uniform vec2 Port_Default_N024;
uniform vec2 Port_Center_N048;
...
varying vec2 varScreenTexturePos;
varying vec4 varColor;
void Node24_Switch(float Switch,vec2 Value0,vec2 Value1,vec2 Value2,vec2 Default,out vec2 Result,ssGlobals Globals)
{
#if (NODE_7_DROPLIST_ITEM==0)
{
Value0=vec2(Globals.SurfacePosition_ObjectSpace.xy);
Result=Value0;
}
#else
{
#if (NODE_7_DROPLIST_ITEM==1)
{
Value1=vec2(Globals.SurfacePosition_ObjectSpace.yz);
Result=Value1;
}
#else
{
#if (NODE_7_DROPLIST_ITEM==2)
{
Value2=vec2(Globals.SurfacePosition_ObjectSpace.zx);
Result=Value2;
}
#else
{
...
void Node48_Rotate_Coords(vec2 CoordsIn,float Rotation,vec2 Center,out vec2 CoordsOut,ssGlobals Globals)
{
...
vec3 ssHSV_to_RGB(vec3 HSV)
{
vec3 l9_0=HSV;
float l9_1=HSV.x;
float l9_2=3.0*fract(l9_1+0.16666667);
float l9_3=2.0*fract(l9_2);
float l9_4=HSV.z;
float l9_5=HSV.y;
vec2 l9_6=l9_0.zz-((vec2(1.0,l9_3)-vec2(max(0.0,l9_3-1.0)))*(l9_4*clamp(l9_5,0.0,1.0)));
vec3 l9_7=vec3(l9_0.z,l9_6.x,l9_6.y);
vec3 l9_8;
if (l9_2>=1.0)
{
l9_8=l9_7.zxy;
...
#endif
ssGlobals l9_0=ssGlobals(sc_Time.x,sc_Time.y,0.0,(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz,varPackedTex.xy);
vec4 l9_1;
#if (Tweak_N9)
{
vec2 l9_2;
Node24_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),Port_Default_N024,l9_2,l9_0);
vec2 l9_3;
Node48_Rotate_Coords(l9_2,rotationAngle,Port_Center_N048,l9_3,l9_0);
vec3 l9_4=ssHSV_to_RGB(vec4(((l9_3*vec2(size*Port_Input1_N011))+vec2(sc_Time.x*speed)).x,1.0,1.0,1.0).xyz);
vec4 l9_5=vec4(l9_4,1.0);
int l9_6;
...
#endif
bool l9_7=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_8=varPackedTex.x;
sc_SoftwareWrapEarly(l9_8,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_9=l9_8;
float l9_10=varPackedTex.y;
sc_SoftwareWrapEarly(l9_10,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_11=l9_10;
vec2 l9_12;
float l9_13;
...
{
l9_14=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_15=l9_9;
float l9_16=1.0;
sc_ClampUV(l9_15,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_14,l9_16);
float l9_17=l9_15;
float l9_18=l9_16;
bool l9_19;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_19=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_19=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_20=l9_11;
float l9_21=l9_18;
sc_ClampUV(l9_20,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_19,l9_21);
l9_13=l9_21;
...
#endif
vec2 l9_22=sc_TransformUV(l9_12,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_23=l9_22.x;
float l9_24=l9_13;
sc_SoftwareWrapLate(l9_23,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_7,l9_24);
float l9_25=l9_22.y;
float l9_26=l9_24;
sc_SoftwareWrapLate(l9_25,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_7,l9_26);
float l9_27=l9_26;
vec3 l9_28=sc_SamplingCoordsViewToGlobal(vec2(l9_23,l9_25),opacityTexLayout,l9_6);
vec4 l9_29=texture2D(opacityTex,l9_28.xy,0.0);
vec4 l9_30;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_30=mix(opacityTexBorderColor,l9_29,vec4(l9_27));
}
#else
{
l9_30=l9_29;
...
#endif
vec4 l9_31=vec4(l9_5.x,l9_5.y,l9_5.z,vec4(0.0).w);
l9_31.w=l9_30.x;
l9_1=l9_31;
}
#else
{
vec2 l9_32;
Node24_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),Port_Default_N024,l9_32,l9_0);
vec2 l9_33;
Node48_Rotate_Coords(l9_32,rotationAngle,Port_Center_N048,l9_33,l9_0);
l9_1=vec4(ssHSV_to_RGB(vec4(((l9_33*vec2(size*Port_Input1_N011))+vec2(sc_Time.x*speed)).x,1.0,1.0,1.0).xyz),1.0);
}
#endif
...
{
l9_36=clamp(l9_1.w*2.0,0.0,1.0);
}
#else
{
float l9_37;
...
{
l9_37=clamp(dot(l9_1.xyz,vec3(l9_1.w)),0.0,1.0);
}
#else
{
float l9_38;
...
{
l9_39=(1.0-dot(l9_1.xyz,vec3(0.33333001)))*l9_1.w;
}
#else
{
float l9_40;
...
{
l9_40=(1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0))*l9_1.w;
}
#else
{
float l9_41;
...
{
l9_41=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_1.w;
}
#else
{
float l9_42;
#if (sc_BlendMode_Add)
{
l9_42=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_43;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_43=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_1.w;
}
#else
{
float l9_44;
...
{
l9_44=dot(l9_1.xyz,vec3(0.33333001))*l9_1.w;
}
#else
{
float l9_45;
#if (sc_BlendMode_Min)
{
l9_45=1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_46;
#if (sc_BlendMode_Max)
{
l9_46=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_46=1.0;
...
#endif
l9_34=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_1.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_35);
}
#else
{
vec4 l9_47;
...
#endif
l9_49=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_53,sc_ScreenTextureLayout,l9_54).xy,0.0);
}
#endif
vec4 l9_55;
...
{
vec4 l9_56=l9_49;
l9_56.x=l9_49.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_55=l9_56;
}
#else
{
...
#endif
vec3 l9_57=mix(l9_55.xyz,definedBlend(l9_55.xyz,l9_1.xyz).xyz,vec3(l9_1.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_59=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_1.w)),l9_1.w);
}
#else
{
vec4 l9_60;
...
#endif
l9_60=vec4(l9_1.xyz*l9_61,l9_61);
}
#else
{
l9_60=l9_1;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_68-0.0039215689)),min(1.0,l9_68+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_69).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_70=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_69).xy);
float l9_71=packValue(l9_70);
int l9_78=int(l9_67.w*255.0);
float l9_79=packValue(l9_78);
sc_writeFragData0Internal(vec4(packValue(l9_70),packValue(l9_70),packValue(l9_70),packValue(l9_70)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
if (l9_87==0)
{
l9_90=texture2D(sc_OITAlpha0,l9_82);
l9_89=texture2D(sc_OITDepthLow0,l9_82);
l9_88=texture2D(sc_OITDepthHigh0,l9_82);
}
else
{
l9_90=vec4(0.0);
...
if (l9_87==1)
{
l9_93=texture2D(sc_OITAlpha1,l9_82);
l9_92=texture2D(sc_OITDepthLow1,l9_82);
l9_91=texture2D(sc_OITDepthHigh1,l9_82);
}
else
{
l9_93=l9_90;
...
vec4 l9_108=texture2D(sc_OITFilteredDepthBoundsTexture,l9_82);
...
sc_writeFragData0Internal(l9_67,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_66,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
