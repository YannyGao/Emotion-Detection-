...
//float rotationAngle 4272
//float size 4276
//float speed 4280
//float3x3 opacityTexTransform 4336
//float4 opacityTexUvMinMax 4384
//float4 opacityTexBorderColor 4400
//float2 Port_Default_N024 4424
//float2 Port_Center_N048 4440
//float Port_Input1_N011 4452
//float depthRef 4460
//}
...
//spec_const bool SC_USE_UV_MIN_MAX_opacityTex 34 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 35 0
//spec_const bool SC_USE_UV_TRANSFORM_opacityTex 36 0
//spec_const bool Tweak_N9 37 0
//spec_const bool UseViewSpaceDepthVariant 38 1
//spec_const bool intensityTextureHasSwappedViews 39 0
//spec_const bool opacityTexHasSwappedViews 40 0
...
//spec_const int NODE_7_DROPLIST_ITEM 72 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 74 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 76 -1
//spec_const int intensityTextureLayout 77 0
//spec_const int opacityTexLayout 78 0
...
float2 l9_9=(*sc_set0.UserUniforms).Port_Default_N024;
ssGlobals l9_10=param_3;
float2 l9_11;
if (NODE_7_DROPLIST_ITEM_tmp==0)
{
float3 l9_12=float3(0.0);
l9_12=l9_10.SurfacePosition_ObjectSpace;
float2 l9_13=float2(0.0);
l9_13=float2(l9_12.x,l9_12.y);
l9_6=l9_13;
l9_11=l9_6;
}
else
...
l9_14=l9_10.SurfacePosition_ObjectSpace;
float2 l9_15=float2(0.0);
l9_15=float2(l9_14.y,l9_14.z);
l9_7=l9_15;
l9_11=l9_7;
}
else
...
l9_16=l9_10.SurfacePosition_ObjectSpace;
float2 l9_17=float2(0.0);
l9_17=float2(l9_16.z,l9_16.x);
l9_8=l9_17;
l9_11=l9_8;
}
else
...
l9_5=l9_11;
float l9_18=0.0;
float l9_19=(*sc_set0.UserUniforms).rotationAngle;
l9_18=l9_19;
float l9_20=0.0;
l9_20=l9_18;
...
float2 l9_22=l9_5;
float l9_23=l9_20;
float2 l9_24=(*sc_set0.UserUniforms).Port_Center_N048;
float l9_25=sin(radians(l9_23));
float l9_26=cos(radians(l9_23));
float2 l9_27=l9_22-l9_24;
l9_27=float2(dot(float2(l9_26,l9_25),l9_27),dot(float2(-l9_25,l9_26),l9_27))+l9_24;
l9_21=l9_27;
float l9_28=0.0;
float l9_29=(*sc_set0.UserUniforms).size;
l9_28=l9_29;
float l9_30=0.0;
l9_30=l9_28;
float l9_31=0.0;
l9_31=l9_30*(*sc_set0.UserUniforms).Port_Input1_N011;
float2 l9_32=float2(0.0);
l9_32=l9_21*float2(l9_31);
float l9_33=0.0;
float l9_34=(*sc_set0.UserUniforms).speed;
l9_33=l9_34;
float l9_35=0.0;
l9_35=l9_33;
float l9_36=0.0;
l9_36=param_3.gTimeElapsed*l9_35;
float2 l9_37=float2(0.0);
l9_37=l9_32+float2(l9_36);
float4 l9_38=float4(0.0);
l9_38=float4(l9_37.x,1.0,1.0,1.0);
float4 l9_39=float4(0.0);
float3 l9_40=l9_38.xyz;
float3 l9_41=l9_40.zzz;
float l9_42=3.0*fract(l9_40.x+0.16666667);
float l9_43=2.0*fract(l9_42);
float l9_44=l9_40.y;
float l9_45=fast::clamp(l9_44,0.0,1.0);
float2 l9_46=l9_41.yz-((float2(1.0,l9_43)-float2(fast::max(0.0,l9_43-1.0)))*(l9_40.z*l9_45));
l9_41=float3(l9_41.x,l9_46.x,l9_46.y);
if (l9_42>=1.0)
{
l9_41=l9_41.zxy;
}
...
float3 l9_47=l9_41;
l9_39=float4(l9_47,l9_38.w);
float4 l9_48=float4(0.0);
l9_48=l9_39;
float2 l9_49=float2(0.0);
l9_49=param_3.Surface_UVCoord0;
...
int l9_56=l9_51;
int l9_57=opacityTexLayout_tmp;
int l9_58=l9_56;
float2 l9_59=l9_49;
bool l9_60=(int(SC_USE_UV_TRANSFORM_opacityTex_tmp)!=0);
float3x3 l9_61=(*sc_set0.UserUniforms).opacityTexTransform;
int2 l9_62=int2(SC_SOFTWARE_WRAP_MODE_U_opacityTex_tmp,SC_SOFTWARE_WRAP_MODE_V_opacityTex_tmp);
bool l9_63=(int(SC_USE_UV_MIN_MAX_opacityTex_tmp)!=0);
float4 l9_64=(*sc_set0.UserUniforms).opacityTexUvMinMax;
bool l9_65=(int(SC_USE_CLAMP_TO_BORDER_opacityTex_tmp)!=0);
float4 l9_66=(*sc_set0.UserUniforms).opacityTexBorderColor;
float l9_67=0.0;
...
float l9_137=l9_129;
float4 l9_138=sc_set0.opacityTex.sample(sc_set0.opacityTexSmpSC,l9_136,bias(l9_137));
...
l9_143=float4(l9_48.xyz.x,l9_48.xyz.y,l9_48.xyz.z,l9_143.w);
l9_143.w=l9_142;
param=l9_143;
param_2=param;
}
...
float2 l9_148=(*sc_set0.UserUniforms).Port_Default_N024;
ssGlobals l9_149=param_3;
float2 l9_150;
if (NODE_7_DROPLIST_ITEM_tmp==0)
{
float3 l9_151=float3(0.0);
l9_151=l9_149.SurfacePosition_ObjectSpace;
float2 l9_152=float2(0.0);
l9_152=float2(l9_151.x,l9_151.y);
l9_145=l9_152;
l9_150=l9_145;
}
else
...
l9_153=l9_149.SurfacePosition_ObjectSpace;
float2 l9_154=float2(0.0);
l9_154=float2(l9_153.y,l9_153.z);
l9_146=l9_154;
l9_150=l9_146;
}
else
...
l9_155=l9_149.SurfacePosition_ObjectSpace;
float2 l9_156=float2(0.0);
l9_156=float2(l9_155.z,l9_155.x);
l9_147=l9_156;
l9_150=l9_147;
}
else
...
l9_144=l9_150;
float l9_157=0.0;
float l9_158=(*sc_set0.UserUniforms).rotationAngle;
l9_157=l9_158;
float l9_159=0.0;
l9_159=l9_157;
float2 l9_160=float2(0.0);
float2 l9_161=l9_144;
float l9_162=l9_159;
float2 l9_163=(*sc_set0.UserUniforms).Port_Center_N048;
float l9_164=sin(radians(l9_162));
float l9_165=cos(radians(l9_162));
float2 l9_166=l9_161-l9_163;
l9_166=float2(dot(float2(l9_165,l9_164),l9_166),dot(float2(-l9_164,l9_165),l9_166))+l9_163;
l9_160=l9_166;
float l9_167=0.0;
float l9_168=(*sc_set0.UserUniforms).size;
l9_167=l9_168;
float l9_169=0.0;
l9_169=l9_167;
float l9_170=0.0;
l9_170=l9_169*(*sc_set0.UserUniforms).Port_Input1_N011;
float2 l9_171=float2(0.0);
l9_171=l9_160*float2(l9_170);
float l9_172=0.0;
float l9_173=(*sc_set0.UserUniforms).speed;
l9_172=l9_173;
float l9_174=0.0;
l9_174=l9_172;
float l9_175=0.0;
l9_175=param_3.gTimeElapsed*l9_174;
float2 l9_176=float2(0.0);
l9_176=l9_171+float2(l9_175);
float4 l9_177=float4(0.0);
l9_177=float4(l9_176.x,1.0,1.0,1.0);
float4 l9_178=float4(0.0);
float3 l9_179=l9_177.xyz;
float3 l9_180=l9_179.zzz;
float l9_181=3.0*fract(l9_179.x+0.16666667);
float l9_182=2.0*fract(l9_181);
float l9_183=l9_179.y;
float l9_184=fast::clamp(l9_183,0.0,1.0);
float2 l9_185=l9_180.yz-((float2(1.0,l9_182)-float2(fast::max(0.0,l9_182-1.0)))*(l9_179.z*l9_184));
l9_180=float3(l9_180.x,l9_185.x,l9_185.y);
if (l9_181>=1.0)
{
l9_180=l9_180.zxy;
}
...
float3 l9_186=l9_180;
l9_178=float4(l9_186,l9_177.w);
...
bool l9_191=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_191)
{
...
float4 l9_192=fast::max(param_5,float4(0.0));
float4 param_6=l9_192;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float l9_196=l9_195;
float l9_197=l9_196;
float l9_198=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_197;
float3 l9_199=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_193.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
float4 l9_266=param_10;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_266.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
