...
//}
//ubo int UserUniforms 0:33:4352 {
//float4 sc_Time 1376
...
//float borderScale 4288
//float sliceSizeLeft 4292
//float sliceSizeRight 4296
//float sliceSizeTop 4300
//float sliceSizeBottom 4304
//float4 shapeColor 4320
//float depthRef 4336
//}
...
float2 param=(*sc_set0.UserUniforms).baseTexSize.xy;
TextureSize_N1=param;
float2 UVCoord_N3=float2(0.0);
UVCoord_N3=Globals.Surface_UVCoord0;
float Output_N10=0.0;
float param_1=(*sc_set0.UserUniforms).borderScale;
Output_N10=param_1;
float Output_N9=0.0;
float param_2=(*sc_set0.UserUniforms).sliceSizeLeft;
Output_N9=param_2;
float Output_N36=0.0;
float param_3=(*sc_set0.UserUniforms).sliceSizeRight;
Output_N36=param_3;
float Output_N8=0.0;
float param_4=(*sc_set0.UserUniforms).sliceSizeTop;
Output_N8=param_4;
float Output_N13=0.0;
float param_5=(*sc_set0.UserUniforms).sliceSizeBottom;
Output_N13=param_5;
float2 Result_N2=float2(0.0);
float2 param_6=UVCoord_N3;
float param_7=Output_N10;
float param_8=Output_N9;
float param_9=Output_N36;
float param_10=Output_N8;
float param_11=Output_N13;
float2 param_12=TextureSize_N1;
float2 param_13=float2(0.0);
N2_UV=param_6;
N2_MaxBorderSize=param_7;
N2_SliceLeft=param_8;
N2_SliceRight=param_9;
N2_SliceTop=param_10;
N2_SliceBottom=param_11;
N2_TextureSize=param_12;
float4x4 l9_7=(*sc_set0.UserUniforms).sc_ModelMatrix;
float l9_8=length(l9_7[0].xyz);
float4x4 l9_9=(*sc_set0.UserUniforms).sc_ModelMatrix;
float l9_10=length(l9_9[1].xyz);
float2 l9_11=float2(l9_8,l9_10);
int l9_12=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_12=0;
...
int l9_13=l9_12;
float4x4 l9_14=(*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_13];
float l9_15=l9_14[3].w;
float l9_16=0.0;
float l9_17=l9_15;
float l9_18=l9_16;
bool l9_19=(l9_17+0.00050000002)>l9_18;
bool l9_20;
if (l9_19)
{
l9_20=(l9_15-0.00050000002)<l9_16;
}
else
{
l9_20=l9_19;
...
int l9_24=l9_23;
float4x4 l9_25=(*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_24];
int l9_26=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_26=0;
...
int l9_27=l9_26;
float4x4 l9_28=(*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_27];
float2 l9_29=abs(float2(l9_25[0].x,l9_28[1].y));
float l9_30=l9_29.y/0.1;
l9_11*=l9_30;
}
float l9_31=N2_MaxBorderSize;
float2 l9_32=l9_11;
float l9_33=fast::min(fast::min(l9_31,l9_32.x/2.0),l9_32.y/2.0);
float l9_34=l9_33;
float2 l9_35=N2_TextureSize;
float l9_36=l9_34;
float2 l9_37=float2((l9_35.x/l9_35.y)*l9_36,l9_36);
float2 l9_38=l9_37;
float l9_39=((N2_SliceLeft*l9_38.x)*2.0)/l9_11.x;
float l9_40=1.0-(((N2_SliceRight*l9_38.x)*2.0)/l9_11.x);
float l9_41=((N2_SliceBottom*l9_38.y)*2.0)/l9_11.y;
float l9_42=1.0-(((N2_SliceTop*l9_38.y)*2.0)/l9_11.y);
float l9_43=0.0+(((N2_UV.x-0.0)*(N2_SliceLeft-0.0))/(l9_39-0.0));
float l9_44=N2_SliceLeft+(((N2_UV.x-l9_39)*((1.0-N2_SliceRight)-N2_SliceLeft))/(l9_40-l9_39));
float l9_45=(1.0-N2_SliceRight)+(((N2_UV.x-l9_40)*(1.0-(1.0-N2_SliceRight)))/(1.0-l9_40));
float l9_46=0.0+(((N2_UV.y-0.0)*(N2_SliceBottom-0.0))/(l9_41-0.0));
float l9_47=N2_SliceBottom+(((N2_UV.y-l9_41)*((1.0-N2_SliceTop)-N2_SliceBottom))/(l9_42-l9_41));
float l9_48=(1.0-N2_SliceTop)+(((N2_UV.y-l9_42)*(1.0-(1.0-N2_SliceTop)))/(1.0-l9_42));
float l9_49;
if (N2_UV.x<l9_39)
{
l9_49=l9_43;
...
{
l9_49=(N2_UV.x<l9_40) ? l9_44 : l9_45;
}
float l9_50=l9_49;
float l9_51;
if (N2_UV.y<l9_41)
...
{
l9_51=(N2_UV.y<l9_42) ? l9_47 : l9_48;
}
float l9_52=l9_51;
N2_Result=float2(l9_50,l9_52);
param_13=N2_Result;
Result_N2=param_13;
...
float param_24=0.0;
bool l9_59=param_22&&(!param_20);
float l9_60=1.0;
float l9_61=param_16.x;
int l9_62=param_19.x;
if (l9_62==1)
{
l9_61=fract(l9_61);
}
...
if (l9_62==2)
{
float l9_63=fract(l9_61);
float l9_64=l9_61-l9_63;
float l9_65=step(0.25,fract(l9_64*0.5));
l9_61=mix(l9_63,1.0-l9_63,fast::clamp(l9_65,0.0,1.0));
}
}
param_16.x=l9_61;
float l9_66=param_16.y;
int l9_67=param_19.y;
if (l9_67==1)
{
l9_66=fract(l9_66);
}
...
float l9_73=param_16.x;
float l9_74=param_21.x;
float l9_75=param_21.z;
bool l9_76=l9_72;
float l9_77=l9_60;
...
float l9_82=param_16.y;
float l9_83=param_21.y;
float l9_84=param_21.w;
bool l9_85=l9_81;
float l9_86=l9_60;
...
float2 l9_89=param_16;
bool l9_90=param_17;
float3x3 l9_91=param_18;
if (l9_90)
{
l9_89=float2((l9_91*float3(l9_89,1.0)).xy);
}
float2 l9_92=l9_89;
float2 l9_93=l9_92;
float2 l9_94=l9_93;
param_16=l9_94;
float l9_95=param_16.x;
int l9_96=param_19.x;
bool l9_97=l9_59;
float l9_98=l9_60;
if ((l9_96==0)||(l9_96==3))
{
...
param_16.x=l9_95;
l9_60=l9_98;
float l9_106=param_16.y;
int l9_107=param_19.y;
bool l9_108=l9_59;
float l9_109=l9_60;
...
param_16.y=l9_106;
l9_60=l9_109;
float2 l9_117=param_16;
int l9_118=param_14;
int l9_119=param_15;
float l9_120=param_24;
...
float2 l9_127=l9_126.xy;
float l9_128=l9_120;
float4 l9_129=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_127,bias(l9_128));
float4 l9_130=l9_129;
float4 l9_131=l9_130;
if (param_22)
{
l9_131=mix(param_23,l9_131,float4(l9_60));
}
float4 l9_132=l9_131;
Color_N0=l9_132;
float4 Output_N12=float4(0.0);
float4 param_25=(*sc_set0.UserUniforms).shapeColor;
Output_N12=param_25;
...
float2 l9_134=floor(mod(l9_133.xy,float2(4.0)));
float l9_135=(mod(dot(l9_134,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_26<l9_135)
{
discard_fragment();
}
}
bool l9_136=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_136)
{
...
float4 l9_137=fast::max(param_27,float4(0.0));
float4 param_28=l9_137;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_140=fast::clamp(l9_139.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_140=fast::clamp(dot(l9_139.xyz,float3(l9_139.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_140=(1.0-dot(l9_139.xyz,float3(0.33333001)))*l9_139.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_140=(1.0-fast::clamp(dot(l9_139.xyz,float3(1.0)),0.0,1.0))*l9_139.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_140=fast::clamp(dot(l9_139.xyz,float3(1.0)),0.0,1.0)*l9_139.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_140=fast::clamp(dot(l9_139.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_140=dot(l9_139.xyz,float3(0.33333001))*l9_139.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_140=1.0-fast::clamp(dot(l9_139.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_141=l9_140;
float l9_142=l9_141;
float l9_143=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_142;
float3 l9_144=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_138.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_145=float4(l9_144.x,l9_144.y,l9_144.z,l9_143);
param_29=l9_145;
}
else
{
...
{
float4 l9_149=out.FragColor0;
float4 l9_150=l9_149;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_150.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_153=l9_152.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_158=l9_157;
int l9_159=l9_158;
float3 l9_160=float3(l9_154,0.0);
int l9_161=l9_156;
int l9_162=l9_159;
if (l9_161==1)
{
l9_160.y=((2.0*l9_160.y)+float(l9_162))-1.0;
}
float2 l9_163=l9_160.xy;
l9_155=l9_163;
}
else
{
...
int l9_180=sc_ScreenTextureLayout_tmp;
int l9_181=l9_176;
float l9_182=l9_177;
...
float2 l9_189=l9_188.xy;
float l9_190=l9_182;
float4 l9_191=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_189,bias(l9_190));
float4 l9_192=l9_191;
l9_178=l9_192;
float4 l9_193=l9_178;
float4 l9_194=l9_193;
float4 l9_195=l9_194;
l9_148=l9_195;
}
float4 l9_196=l9_148;
float4 l9_197=l9_196;
float3 l9_198=l9_197.xyz;
float3 l9_199=l9_198;
float3 l9_200=l9_146.xyz;
float3 l9_201=definedBlend(l9_199,l9_200,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_147=float4(l9_201.x,l9_201.y,l9_201.z,l9_147.w);
float3 l9_202=mix(l9_198,l9_147.xyz,float3(l9_146.w));
l9_147=float4(l9_202.x,l9_202.y,l9_202.z,l9_147.w);
l9_147.w=1.0;
float4 l9_203=l9_147;
param_29=l9_203;
}
else
{
float4 l9_204=param_29;
float4 l9_205=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_205=float4(mix(float3(1.0),l9_204.xyz,float3(l9_204.w)),l9_204.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_206=l9_204.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_206=fast::clamp(l9_206,0.0,1.0);
}
l9_205=float4(l9_204.xyz*l9_206,l9_206);
}
else
{
l9_205=l9_204;
...
{
l9_209=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_209=float4(0.0);
...
float4 l9_211=param_32;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_211.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_211;
return out;
}
} // FRAGMENT SHADER
