...
//}
//ubo int UserUniforms 0:24:4080 {
...
//float4 Port_FinalColor_N004 4016
//float4 Port_FinalColor1_N004 4032
//float4 Port_FinalColor2_N004 4048
//float4 Port_FinalColor3_N004 4064
//}
...
//spec_const bool sc_TAAEnabled 62
...
float4 Port_FinalColor1_N004;
float4 Port_FinalColor2_N004;
float4 Port_FinalColor3_N004;
};
struct sc_Bone_t
{
float4 boneMatrix[3];
...
float4 FinalColor=(*sc_set0.UserUniforms).Port_FinalColor_N004;
float4 FinalColor1=(*sc_set0.UserUniforms).Port_FinalColor1_N004;
float4 FinalColor2=(*sc_set0.UserUniforms).Port_FinalColor2_N004;
float4 FinalColor3=(*sc_set0.UserUniforms).Port_FinalColor3_N004;
float param=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
{
param_1=float4(param_1.w);
}
else
{
if ((int(sc_BlendMode_Custom_tmp)!=0))
{
float4 l9_11=param_1;
...
float4 param_2=FinalColor1;
out.FragColor1=param_2;
float4 param_3=FinalColor2;
out.FragColor2=param_3;
float4 param_4=FinalColor3;
out.FragColor3=param_4;
