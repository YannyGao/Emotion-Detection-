...
uniform vec4 Port_FinalColor2_N004;
uniform vec4 Port_FinalColor3_N004;
...
vec4 l9_33=max(Port_FinalColor2_N004,vec4(0.0));
vec4 l9_34=max(Port_FinalColor3_N004,vec4(0.0));
sc_writeFragData1(l9_32);
sc_writeFragData2(l9_33);
sc_writeFragData3(l9_34);
vec4 l9_35=outputMotionVectorsIfNeeded(varPos,((max(l9_31,vec4(0.0))+(l9_32*1e-06))+(l9_33*1e-06))+(l9_34*1e-06));
