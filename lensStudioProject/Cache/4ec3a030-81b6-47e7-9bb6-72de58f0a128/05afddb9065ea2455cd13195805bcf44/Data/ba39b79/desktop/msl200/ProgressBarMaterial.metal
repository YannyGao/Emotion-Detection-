...
//}
//ubo int UserUniforms 0:33:4448 {
//float4 sc_Time 1376
...
//float2 aspect 4152
//float2 boxBounds 4160
//float cornerRadius 4168
//float3x3 baseTexTransform 4224
//float4 baseTexUvMinMax 4272
//float4 baseTexBorderColor 4288
//float4 baseColor 4304
//float percentage 4320
//float Port_Value_N061 4324
//float Port_Input1_N023 4328
//float2 Port_Value_N002 4344
//float2 Port_Input1_N089 4360
//float2 Port_Input2_N089 4368
//float Port_Input0_N036 4376
//float2 Port_Input1_N028 4392
//float4 Port_Input1_N003 4416
//float depthRef 4432
//}
...
float param=(*sc_set0.UserUniforms).Port_Value_N061;
float param_1=param+0.001;
param_1-=0.001;
Output_N61=param_1;
float2 UVCoord_N12=float2(0.0);
UVCoord_N12=Globals.Surface_UVCoord0;
float2 Output_N35=float2(0.0);
float2 param_2=(*sc_set0.UserUniforms).aspect;
Output_N35=param_2;
float2 Output_N17=float2(0.0);
Output_N17=UVCoord_N12*Output_N35;
float2 Value_N32=float2(0.0);
Value_N32=Output_N17;
float2 Output_N2=float2(0.0);
float2 param_3=(*sc_set0.UserUniforms).Port_Value_N002;
float2 param_4=param_3+float2(0.001);
param_4-=float2(0.001);
Output_N2=param_4;
float2 Output_N14=float2(0.0);
Output_N14=Output_N2*Output_N35;
...
float2 param_5=(*sc_set0.UserUniforms).boxBounds;
Output_N15=param_5;
...
Output_N36=float2((*sc_set0.UserUniforms).Port_Input0_N036)/Output_N35;
float Output_N5=0.0;
float param_6=(*sc_set0.UserUniforms).cornerRadius;
Output_N5=param_6;
...
Output_N16=Output_N11*Output_N35;
...
float2 param_7=Output_N20;
float2 param_8=param_7;
...
if (l9_8)
{
l9_9=8==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_9=l9_8;
...
PreviewInfo.Color=float4(param_8,0.0,1.0);
...
float param_9=Export_N24;
float param_10=param_9;
...
if (l9_11)
{
l9_12=10==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_12=l9_11;
...
{
PreviewInfo.Saved=true;
PreviewInfo.Color=float4(param_10,param_10,param_10,1.0);
PreviewInfo.Color.w=1.0;
}
Output_N10=param_10;
...
int l9_18=l9_13;
int l9_19=baseTexLayout_tmp;
int l9_20=l9_18;
float2 l9_21=param_12.Surface_UVCoord0;
bool l9_22=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 l9_23=(*sc_set0.UserUniforms).baseTexTransform;
int2 l9_24=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool l9_25=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 l9_26=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool l9_27=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 l9_28=(*sc_set0.UserUniforms).baseTexBorderColor;
float l9_29=0.0;
...
float l9_99=l9_91;
float4 l9_100=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_98,bias(l9_99));
float4 l9_101=l9_100;
float4 l9_102=l9_101;
if (l9_27)
{
l9_102=mix(l9_28,l9_102,float4(l9_31));
}
float4 l9_103=l9_102;
float4 param_11=l9_103;
Output_N6=param_11;
float4 Output_N73=float4(0.0);
float4 param_13=(*sc_set0.UserUniforms).baseColor;
Output_N73=param_13;
float Output_N31=0.0;
float param_14=(*sc_set0.UserUniforms).percentage;
Output_N31=param_14;
float Value1_N13=0.0;
float2 param_15=UVCoord_N12;
float param_16=param_15.x;
Value1_N13=param_16;
float Output_N7=0.0;
Output_N7=float(Output_N31<Value1_N13);
float4 Output_N3=float4(0.0);
Output_N3=mix(Output_N73,(*sc_set0.UserUniforms).Port_Input1_N003,float4(Output_N7));
float4 Output_N0=float4(0.0);
Output_N0=Output_N6*Output_N3;
float4 Output_N48=float4(0.0);
Output_N48=float4(Output_N23)*Output_N0;
float4 Output_N1=float4(0.0);
float4 param_17=Output_N48;
float4 param_18=param_17;
bool l9_104=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_105;
if (l9_104)
{
...
if (l9_105)
{
l9_106=1==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_106=l9_105;
...
float2 l9_108=floor(mod(l9_107.xy,float2(4.0)));
float l9_109=(mod(dot(l9_108,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_19<l9_109)
{
discard_fragment();
}
}
bool l9_110=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_110)
{
...
float4 l9_111=fast::max(param_20,float4(0.0));
float4 param_21=l9_111;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_114=fast::clamp(l9_113.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_114=fast::clamp(dot(l9_113.xyz,float3(l9_113.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_114=(1.0-dot(l9_113.xyz,float3(0.33333001)))*l9_113.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_114=(1.0-fast::clamp(dot(l9_113.xyz,float3(1.0)),0.0,1.0))*l9_113.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_114=fast::clamp(dot(l9_113.xyz,float3(1.0)),0.0,1.0)*l9_113.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_114=fast::clamp(dot(l9_113.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_114=dot(l9_113.xyz,float3(0.33333001))*l9_113.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_114=1.0-fast::clamp(dot(l9_113.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_115=l9_114;
float l9_116=l9_115;
float l9_117=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_116;
float3 l9_118=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_112.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_119=float4(l9_118.x,l9_118.y,l9_118.z,l9_117);
param_22=l9_119;
}
else
{
...
{
float4 l9_123=out.FragColor0;
float4 l9_124=l9_123;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_124.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_127=l9_126.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_132=l9_131;
int l9_133=l9_132;
float3 l9_134=float3(l9_128,0.0);
int l9_135=l9_130;
int l9_136=l9_133;
if (l9_135==1)
{
l9_134.y=((2.0*l9_134.y)+float(l9_136))-1.0;
}
float2 l9_137=l9_134.xy;
l9_129=l9_137;
}
else
{
...
int l9_146=l9_141;
float2 l9_147=l9_140;
int l9_148=l9_146;
float2 l9_149=l9_147;
int l9_150=l9_148;
float l9_151=0.0;
float4 l9_152=float4(0.0);
float2 l9_153=l9_149;
int l9_154=sc_ScreenTextureLayout_tmp;
int l9_155=l9_150;
float l9_156=l9_151;
float2 l9_157=l9_153;
int l9_158=l9_154;
int l9_159=l9_155;
float3 l9_160=float3(0.0);
if (l9_158==0)
{
l9_160=float3(l9_157,0.0);
}
else
{
if (l9_158==1)
{
l9_160=float3(l9_157.x,(l9_157.y*0.5)+(0.5-(float(l9_159)*0.5)),0.0);
}
else
{
l9_160=float3(l9_157,float(l9_159));
}
}
float3 l9_161=l9_160;
float3 l9_162=l9_161;
float2 l9_163=l9_162.xy;
float l9_164=l9_156;
float4 l9_165=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_163,bias(l9_164));
float4 l9_166=l9_165;
l9_152=l9_166;
float4 l9_167=l9_152;
float4 l9_168=l9_167;
float4 l9_169=l9_168;
l9_122=l9_169;
}
float4 l9_170=l9_122;
float4 l9_171=l9_170;
float3 l9_172=l9_171.xyz;
float3 l9_173=l9_172;
float3 l9_174=l9_120.xyz;
float3 l9_175=definedBlend(l9_173,l9_174,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_121=float4(l9_175.x,l9_175.y,l9_175.z,l9_121.w);
float3 l9_176=mix(l9_172,l9_121.xyz,float3(l9_120.w));
l9_121=float4(l9_176.x,l9_176.y,l9_176.z,l9_121.w);
l9_121.w=1.0;
float4 l9_177=l9_121;
param_22=l9_177;
}
else
{
float4 l9_178=param_22;
float4 l9_179=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_179=float4(mix(float3(1.0),l9_178.xyz,float3(l9_178.w)),l9_178.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_180=l9_178.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_180=fast::clamp(l9_180,0.0,1.0);
}
l9_179=float4(l9_178.xyz*l9_180,l9_180);
}
else
{
l9_179=l9_178;
...
float4 l9_181=l9_179;
param_22=l9_181;
}
}
}
float4 l9_182=param_22;
FinalColor=l9_182;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_183=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_183=float4(0.0);
...
float4 l9_185=param_25;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_185.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_185;
return out;
}
} // FRAGMENT SHADER
