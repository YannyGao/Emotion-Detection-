...
vec2 l9_1=abs((varPackedTex.xy*aspect)-(((Port_Value_N002+vec2(0.001))-vec2(0.001))*aspect))-((clamp(boxBounds,Port_Input1_N089,Port_Input2_N089)-((vec2(Port_Input0_N036)/aspect)*vec2(cornerRadius)))*aspect);
...
bool l9_4;
vec4 l9_5;
if (l9_3&&(8==PreviewNodeID))
{
vec4 l9_6=vec4(l9_1,0.0,1.0);
l9_6.w=1.0;
l9_5=l9_6;
l9_4=true;
}
...
float l9_7=length(max(l9_1,Port_Input1_N028))-cornerRadius;
bool l9_8;
if (l9_2)
{
l9_8=!l9_4;
...
{
vec4 l9_11=vec4(l9_7,l9_7,l9_7,1.0);
l9_11.w=1.0;
l9_10=l9_11;
l9_9=true;
}
...
#endif
vec4 l9_36=l9_35*mix(baseColor,Port_Input1_N003,vec4(float(percentage<varPackedTex.x)));
vec4 l9_37=vec4(smoothstep((Port_Value_N061+0.001)-0.001,Port_Input1_N023,l9_7))*l9_36;
bool l9_38;
if (l9_2)
{
l9_38=!l9_9;
...
{
if (l9_42<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_46=clamp(dot(l9_37.xyz,vec3(l9_42)),0.0,1.0);
}
#else
{
float l9_47;
...
{
l9_48=(1.0-dot(l9_37.xyz,vec3(0.33333001)))*l9_42;
}
#else
{
float l9_49;
...
{
l9_49=(1.0-clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0))*l9_42;
}
#else
{
float l9_50;
...
{
l9_50=clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0)*l9_42;
}
#else
{
float l9_51;
#if (sc_BlendMode_Add)
{
l9_51=clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_52;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_52=clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0)*l9_42;
}
#else
{
float l9_53;
...
{
l9_53=dot(l9_37.xyz,vec3(0.33333001))*l9_42;
}
#else
{
float l9_54;
#if (sc_BlendMode_Min)
{
l9_54=1.0-clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_55;
#if (sc_BlendMode_Max)
{
l9_55=clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_55=1.0;
...
#endif
l9_43=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_37.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_44);
}
#else
{
vec4 l9_56;
...
#endif
vec3 l9_66=mix(l9_64.xyz,definedBlend(l9_64.xyz,l9_37.xyz).xyz,vec3(l9_42));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_68=vec4(mix(vec3(1.0),l9_37.xyz,vec3(l9_42)),l9_42);
}
#else
{
vec4 l9_69;
...
#endif
l9_69=vec4(l9_37.xyz*l9_70,l9_70);
}
#else
{
l9_69=l9_37;
