...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_handGlowTex 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_handGlowTex 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 82 -1
//spec_const int handGlowTexLayout 83 0
...
#endif
bool l9_1=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_handGlowTex)!=0));
float l9_2=varPackedTex.x;
sc_SoftwareWrapEarly(l9_2,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x);
float l9_3=l9_2;
float l9_4=varPackedTex.y;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y);
float l9_5=l9_4;
vec2 l9_6;
float l9_7;
...
{
l9_8=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x==3;
}
#else
{
l9_8=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_9=l9_3;
float l9_10=1.0;
sc_ClampUV(l9_9,handGlowTexUvMinMax.x,handGlowTexUvMinMax.z,l9_8,l9_10);
float l9_11=l9_9;
float l9_12=l9_10;
bool l9_13;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_14=l9_5;
float l9_15=l9_12;
sc_ClampUV(l9_14,handGlowTexUvMinMax.y,handGlowTexUvMinMax.w,l9_13,l9_15);
l9_7=l9_15;
...
#endif
vec2 l9_16=sc_TransformUV(l9_6,(int(SC_USE_UV_TRANSFORM_handGlowTex)!=0),handGlowTexTransform);
float l9_17=l9_16.x;
float l9_18=l9_7;
sc_SoftwareWrapLate(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x,l9_1,l9_18);
float l9_19=l9_16.y;
float l9_20=l9_18;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y,l9_1,l9_20);
float l9_21=l9_20;
vec3 l9_22=sc_SamplingCoordsViewToGlobal(vec2(l9_17,l9_19),handGlowTexLayout,l9_0);
vec4 l9_23=texture2D(handGlowTex,l9_22.xy,0.0);
vec4 l9_24;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_24=mix(handGlowTexBorderColor,l9_23,vec4(l9_21));
}
#else
{
l9_24=l9_23;
...
#endif
float l9_25=mix(Port_Input0_N003,indexBrightness,l9_24.x);
vec4 l9_26=vec4(indexGlowColor.xyz,l9_25);
vec3 l9_27=l9_26.xyz*l9_25;
vec4 l9_28=vec4(l9_27.x,l9_27.y,l9_27.z,l9_26.w)+(vec4(thumbGlowColor.xyz,mix(Port_Input0_N011,thumbBrightness,l9_24.y))*(1.0-l9_25));
float l9_29=l9_28.w;
