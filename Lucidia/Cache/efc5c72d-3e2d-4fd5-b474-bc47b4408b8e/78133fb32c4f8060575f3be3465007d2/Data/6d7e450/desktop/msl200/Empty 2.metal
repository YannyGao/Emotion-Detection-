...
//float Confusion 4272
//float3x3 Tweak_N3Transform 4336
//float4 Tweak_N3UvMinMax 4384
//float4 Tweak_N3BorderColor 4400
//float4 emotionColor 4416
//float depthRef 4432
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N3 31 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 32 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N3 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N3 35 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36 0
//spec_const bool Tweak_N3HasSwappedViews 37 0
...
float Output_N2=0.0;
float param=(*sc_set0.UserUniforms).Confusion;
Output_N2=param;
...
int l9_10=l9_5;
int param_1=Tweak_N3Layout_tmp;
int param_2=l9_10;
float2 param_3=Globals.Surface_UVCoord0;
bool param_4=(int(SC_USE_UV_TRANSFORM_Tweak_N3_tmp)!=0);
float3x3 param_5=(*sc_set0.UserUniforms).Tweak_N3Transform;
int2 param_6=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3_tmp);
bool param_7=(int(SC_USE_UV_MIN_MAX_Tweak_N3_tmp)!=0);
float4 param_8=(*sc_set0.UserUniforms).Tweak_N3UvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).Tweak_N3BorderColor;
float param_11=0.0;
bool l9_11=param_9&&(!param_7);
float l9_12=1.0;
float l9_13=param_3.x;
int l9_14=param_6.x;
if (l9_14==1)
{
l9_13=fract(l9_13);
...
float l9_26=param_8.x;
float l9_27=param_8.z;
bool l9_28=l9_24;
float l9_29=l9_12;
...
float l9_34=param_3.y;
float l9_35=param_8.y;
float l9_36=param_8.w;
bool l9_37=l9_33;
float l9_38=l9_12;
...
float2 l9_41=param_3;
bool l9_42=param_4;
float3x3 l9_43=param_5;
if (l9_42)
{
...
param_3.y=l9_58;
l9_12=l9_61;
float2 l9_69=param_3;
int l9_70=param_1;
int l9_71=param_2;
float l9_72=param_11;
float2 l9_73=l9_69;
int l9_74=l9_70;
int l9_75=l9_71;
...
float l9_80=l9_72;
float4 l9_81=sc_set0.Tweak_N3.sample(sc_set0.Tweak_N3SmpSC,l9_79,bias(l9_80));
float4 l9_82=l9_81;
float4 l9_83=l9_82;
if (param_9)
{
l9_83=mix(param_10,l9_83,float4(l9_12));
}
float4 l9_84=l9_83;
Output_N3=l9_84;
float4 Output_N5=float4(0.0);
float4 param_12=(*sc_set0.UserUniforms).emotionColor;
Output_N5=param_12;
float4 Output_N1=float4(0.0);
Output_N1=Output_N3*Output_N5;
float4 Output_N0=float4(0.0);
Output_N0=float4(Output_N2)*Output_N1;
...
bool l9_88=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_88)
{
...
{
l9_92=fast::clamp(l9_91.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_92=fast::clamp(dot(l9_91.xyz,float3(l9_91.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_92=(1.0-dot(l9_91.xyz,float3(0.33333001)))*l9_91.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_92=(1.0-fast::clamp(dot(l9_91.xyz,float3(1.0)),0.0,1.0))*l9_91.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_92=fast::clamp(dot(l9_91.xyz,float3(1.0)),0.0,1.0)*l9_91.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_92=fast::clamp(dot(l9_91.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_92=dot(l9_91.xyz,float3(0.33333001))*l9_91.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_92=1.0-fast::clamp(dot(l9_91.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_93=l9_92;
float l9_94=l9_93;
float l9_95=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_94;
float3 l9_96=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_90.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_97=float4(l9_96.x,l9_96.y,l9_96.z,l9_95);
param_16=l9_97;
}
else
{
...
{
float4 l9_98=param_16;
float4 l9_99=float4(0.0);
float4 l9_100=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_101=out.FragColor0;
float4 l9_102=l9_101;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_102.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_104=gl_FragCoord;
float2 l9_105=l9_104.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_110=l9_109;
int l9_111=l9_110;
float3 l9_112=float3(l9_106,0.0);
int l9_113=l9_108;
int l9_114=l9_111;
if (l9_113==1)
{
l9_112.y=((2.0*l9_112.y)+float(l9_114))-1.0;
}
...
float l9_142=l9_134;
float4 l9_143=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_141,bias(l9_142));
float4 l9_144=l9_143;
l9_130=l9_144;
float4 l9_145=l9_130;
float4 l9_146=l9_145;
float4 l9_147=l9_146;
l9_100=l9_147;
}
float4 l9_148=l9_100;
float4 l9_149=l9_148;
float3 l9_150=l9_149.xyz;
float3 l9_151=l9_150;
float3 l9_152=l9_98.xyz;
float3 l9_153=definedBlend(l9_151,l9_152,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_99=float4(l9_153.x,l9_153.y,l9_153.z,l9_99.w);
float3 l9_154=mix(l9_150,l9_99.xyz,float3(l9_98.w));
l9_99=float4(l9_154.x,l9_154.y,l9_154.z,l9_99.w);
l9_99.w=1.0;
float4 l9_155=l9_99;
param_16=l9_155;
}
...
{
l9_161=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_161=float4(0.0);
...
float3 param_17=in.varPos;
float4 param_18=FinalColor;
FinalColor=outputMotionVectorsIfNeeded(param_17,param_18,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_19=FinalColor;
float4 l9_163=param_19;
if (sc_ShaderCacheConstant_tmp!=0)
{
