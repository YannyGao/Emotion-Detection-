...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N3 32 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 33 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N3 34 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 35 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N3 36 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 37 0
//spec_const bool Tweak_N3HasSwappedViews 38 0
...
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 59 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N3 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N3 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 82 -1
//spec_const int Tweak_N3Layout 83 0
...
uniform float Confusion;
uniform vec4 emotionColor;
...
#endif
bool l9_1=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0));
float l9_2=varPackedTex.x;
sc_SoftwareWrapEarly(l9_2,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).x);
float l9_3=l9_2;
float l9_4=varPackedTex.y;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).y);
float l9_5=l9_4;
vec2 l9_6;
float l9_7;
...
{
l9_8=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).x==3;
}
#else
{
l9_8=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0);
}
#endif
float l9_9=l9_3;
float l9_10=1.0;
sc_ClampUV(l9_9,Tweak_N3UvMinMax.x,Tweak_N3UvMinMax.z,l9_8,l9_10);
float l9_11=l9_9;
float l9_12=l9_10;
bool l9_13;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N3)
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).y==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0);
}
#endif
float l9_14=l9_5;
float l9_15=l9_12;
sc_ClampUV(l9_14,Tweak_N3UvMinMax.y,Tweak_N3UvMinMax.w,l9_13,l9_15);
l9_7=l9_15;
...
#endif
vec2 l9_16=sc_TransformUV(l9_6,(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform);
float l9_17=l9_16.x;
float l9_18=l9_7;
sc_SoftwareWrapLate(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).x,l9_1,l9_18);
float l9_19=l9_16.y;
float l9_20=l9_18;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).y,l9_1,l9_20);
float l9_21=l9_20;
vec3 l9_22=sc_SamplingCoordsViewToGlobal(vec2(l9_17,l9_19),Tweak_N3Layout,l9_0);
vec4 l9_23=texture2D(Tweak_N3,l9_22.xy,0.0);
vec4 l9_24;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N3)
{
l9_24=mix(Tweak_N3BorderColor,l9_23,vec4(l9_21));
}
#else
{
l9_24=l9_23;
...
#endif
vec4 l9_25=l9_24*emotionColor;
vec4 l9_26=vec4(Confusion)*l9_25;
float l9_27=l9_26.w;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_62-0.0039215689)),min(1.0,l9_62+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_64),packValue(l9_64),packValue(l9_64),packValue(l9_64)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_61,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
