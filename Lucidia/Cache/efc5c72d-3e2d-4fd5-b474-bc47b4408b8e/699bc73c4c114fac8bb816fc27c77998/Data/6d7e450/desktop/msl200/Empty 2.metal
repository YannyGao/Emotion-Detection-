...
//float Tweak_N2 4272
//float4 Confusion 4288
//float4 Port_Input0_N001 4304
//float depthRef 4320
//}
...
float4 param_1=(*sc_set0.UserUniforms).Confusion;
Output_N5=param_1;
float4 Output_N1=float4(0.0);
Output_N1=(*sc_set0.UserUniforms).Port_Input0_N001*Output_N5;
