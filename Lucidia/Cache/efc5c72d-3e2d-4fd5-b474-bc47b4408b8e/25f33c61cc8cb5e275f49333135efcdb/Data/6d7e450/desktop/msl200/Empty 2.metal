...
Output_N1=Output_N3*(*sc_set0.UserUniforms).Port_Input1_N001;
...
float4 l9_89=fast::max(param_13,float4(0.0));
float4 param_14=l9_89;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
FinalColor=outputMotionVectorsIfNeeded(param_16,param_17,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_18=FinalColor;
float4 l9_163=param_18;
if (sc_ShaderCacheConstant_tmp!=0)
{
