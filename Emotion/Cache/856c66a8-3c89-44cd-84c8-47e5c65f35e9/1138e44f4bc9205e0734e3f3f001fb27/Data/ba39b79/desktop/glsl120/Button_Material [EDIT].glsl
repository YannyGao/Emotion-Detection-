...
//spec_const bool Tweak_N65 38
//spec_const bool Tweak_N67 39
//spec_const bool Tweak_N71 40
//spec_const bool UseViewSpaceDepthVariant 41
//spec_const bool baseTexHasSwappedViews 42
...
//spec_const bool sc_BlendMode_Software 59
//spec_const bool sc_DepthOnly 60
//spec_const bool sc_FramebufferFetch 61
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 62
//spec_const bool sc_IsEditor 63
//spec_const bool sc_MotionVectorsPass 64
//spec_const bool sc_OITCompositingPass 65
//spec_const bool sc_OITDepthBoundsPass 66
//spec_const bool sc_OITDepthGatherPass 67
//spec_const bool sc_OITDepthPrepass 68
//spec_const bool sc_OITFrontLayerPass 69
//spec_const bool sc_OITMaxLayers4Plus1 70
//spec_const bool sc_OITMaxLayers8 71
//spec_const bool sc_OITMaxLayersVisualizeLayerCount 72
//spec_const bool sc_ProjectiveShadowsCaster 73
//spec_const bool sc_ProjectiveShadowsReceiver 74
//spec_const bool sc_RenderAlphaToColor 75
//spec_const bool sc_ScreenTextureHasSwappedViews 76
//spec_const bool sc_ShaderComplexityAnalyzer 77
//spec_const bool sc_TAAEnabled 78
//spec_const bool sc_UseFramebufferFetchMarker 79
//spec_const bool sc_VertexBlending 80
//spec_const bool sc_VertexBlendingUseNormals 81
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 82
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 83
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 84
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 85
//spec_const int baseTexLayout 86
//spec_const int intensityTextureLayout 87
//spec_const int sc_DepthBufferMode 88
//spec_const int sc_RenderingSpace 89
//spec_const int sc_ScreenTextureLayout 90
//spec_const int sc_ShaderCacheConstant 91
//spec_const int sc_SkinBonesCount 92
//spec_const int sc_StereoRenderingMode 93
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 94
//spec_const int sc_StereoViewID 95
//SG_REFLECTION_END
...
uniform float Port_Value_N057;
uniform vec3 Port_Input2_N052;
...
uniform vec2 Port_Default_N040;
uniform vec2 Port_Import_N043;
uniform vec2 Port_Value_N002;
uniform vec2 Port_Import_N045;
uniform vec2 Port_Input1_N089;
uniform vec2 Port_Input2_N089;
uniform float Port_Input0_N036;
uniform vec2 Port_Import_N077;
uniform vec2 Port_Input1_N080;
uniform float Port_Import_N082;
uniform float Port_Value_N061;
uniform float Port_Input1_N023;
uniform vec2 Port_Import_N032;
uniform vec2 Port_Import_N018;
uniform vec2 Port_Import_N021;
uniform vec2 Port_Input1_N028;
uniform float Port_Import_N022;
...
l9_33=varTangent.xyz;
l9_32=l9_30;
l9_31=(sc_ModelMatrix*vec4(((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz*vec3(((Port_Value_N057+0.001)-0.001)+1.0))+Port_Input2_N052,1.0)).xyz;
}
varPos=l9_31;
...
void Node3_Texture_2D_Parameter(vec2 UVCoord,out vec4 Output,out vec2 TextureSize,out vec2 PixelSize,ssGlobals Globals)
{
...
#endif
Output=l9_22;
TextureSize=baseTexSize.xy;
PixelSize=baseTexSize.zw;
}
void Node40_If_else(float Bool1,vec2 Value1,vec2 Default,out vec2 Result,ssGlobals Globals)
{
#if (Tweak_N65)
{
vec4 param_1;
vec2 param_2;
vec2 param_3;
Node3_Texture_2D_Parameter(((Globals.Surface_UVCoord0-Port_Center_N013)*Port_Scale_N013)+Port_Center_N013,param_1,param_2,param_3,Globals);
Value1=param_2/vec2(min(param_2.x,param_2.y));
Result=Value1;
}
#else
{
...
void Node8_Preview(vec2 Input0,out vec2 Output,ssGlobals Globals)
{
Output=Input0;
...
if (l9_1&&(8==PreviewNodeID))
{
PreviewInfo.Saved=true;
PreviewInfo.Color=vec4(Output,0.0,1.0);
PreviewInfo.Color.w=1.0;
}
}
void Node10_Preview(float Input0,out float Output,ssGlobals Globals)
{
Output=Input0;
bool l9_0=PreviewEnabled==1;
bool l9_1;
...
if (l9_1&&(10==PreviewNodeID))
{
PreviewInfo.Saved=true;
PreviewInfo.Color=vec4(Output,Output,Output,1.0);
PreviewInfo.Color.w=1.0;
}
}
...
void Node42_Preview(vec4 Input0,out vec4 Output,ssGlobals Globals)
{
Output=Input0;
bool l9_0=PreviewEnabled==1;
bool l9_1;
...
if (l9_1&&(42==PreviewNodeID))
{
PreviewInfo.Saved=true;
PreviewInfo.Color=Output;
PreviewInfo.Color.w=1.0;
}
}
void Node79_Preview(vec2 Input0,out vec2 Output,ssGlobals Globals)
{
Output=Input0;
bool l9_0=PreviewEnabled==1;
bool l9_1;
...
void Node50_Preview(float Input0,out float Output,ssGlobals Globals)
{
Output=Input0;
bool l9_0=PreviewEnabled==1;
bool l9_1;
...
void Node44_Preview(float Input0,out float Output,ssGlobals Globals)
{
Output=Input0;
bool l9_0=PreviewEnabled==1;
bool l9_1;
...
#if (Tweak_N71)
{
float l9_0=radians(shadowDirection);
vec2 param_3;
Node40_If_else(0.0,vec2(0.0),Port_Default_N040,param_3,Globals);
vec2 l9_1=(((Globals.Surface_UVCoord0-Port_Center_N013)*Port_Scale_N013)+Port_Center_N013)*param_3;
vec2 l9_2=((Port_Value_N002+vec2(0.001))-vec2(0.001))*param_3;
vec2 l9_3=(clamp(boxBounds,Port_Input1_N089,Port_Input2_N089)-((vec2(Port_Input0_N036)/param_3)*vec2(cornerRadius)))*param_3;
vec2 param_6;
Node79_Preview(abs((vec2(cos(l9_0)*shadowOffset,shadowOffset*sin(l9_0))+l9_1)-l9_2)-l9_3,param_6,Globals);
float param_9;
Node50_Preview(length(max(param_6,Port_Input1_N080))-cornerRadius,param_9,Globals);
float param_12;
Node44_Preview(smoothstep(shadowBlur,Port_Input1_N034,param_9),param_12,Globals);
vec4 l9_4=vec4(shadowColor.x,shadowColor.y,shadowColor.z,vec4(0.0).w);
l9_4.w=param_12*shadowColor.w;
vec2 param_15;
Node8_Preview(abs(l9_1-l9_2)-l9_3,param_15,Globals);
float param_18;
Node10_Preview(length(max(param_15,Port_Input1_N028))-cornerRadius,param_18,Globals);
vec4 param_23;
Node55_If_else(0.0,vec4(0.0),vec4(0.0),param_23,Globals);
vec4 l9_5=vec4(smoothstep((Port_Value_N061+0.001)-0.001,Port_Input1_N023,param_18));
vec4 param_26;
Node42_Preview(l9_5*param_23,param_26,Globals);
Value1=mix(l9_4,param_26,l9_5);
Result=Value1;
}
#else
{
vec2 param_31;
Node40_If_else(0.0,vec2(0.0),Port_Default_N040,param_31,Globals);
vec2 param_34;
Node8_Preview(abs(((((Globals.Surface_UVCoord0-Port_Center_N013)*Port_Scale_N013)+Port_Center_N013)*param_31)-(((Port_Value_N002+vec2(0.001))-vec2(0.001))*param_31))-((clamp(boxBounds,Port_Input1_N089,Port_Input2_N089)-((vec2(Port_Input0_N036)/param_31)*vec2(cornerRadius)))*param_31),param_34,Globals);
float param_37;
Node10_Preview(length(max(param_34,Port_Input1_N028))-cornerRadius,param_37,Globals);
vec4 param_42;
Node55_If_else(0.0,vec4(0.0),vec4(0.0),param_42,Globals);
vec4 param_45;
Node42_Preview(vec4(smoothstep((Port_Value_N061+0.001)-0.001,Port_Input1_N023,param_37))*param_42,param_45,Globals);
Default=param_45;
Result=Default;
}
#endif
...
{
vec4 l9_5;
Node70_If_else(0.0,vec4(1.0),vec4(0.0),l9_5,l9_3);
vec4 l9_6=l9_5;
vec2 l9_7;
Node40_If_else(0.0,vec2(0.0),Port_Default_N040,l9_7,l9_3);
vec2 l9_8;
Node8_Preview(abs(((((varPackedTex.xy-Port_Center_N013)*Port_Scale_N013)+Port_Center_N013)*l9_7)-(((Port_Value_N002+vec2(0.001))-vec2(0.001))*l9_7))-((clamp(boxBounds,Port_Input1_N089,Port_Input2_N089)-((vec2(Port_Input0_N036)/l9_7)*vec2(cornerRadius)))*l9_7),l9_8,l9_3);
float l9_9;
Node10_Preview(length(max(l9_8,Port_Input1_N028))-cornerRadius,l9_9,l9_3);
float l9_10=l9_9;
float l9_11=smoothstep(Port_Input0_N038,Port_Input1_N038,l9_10)*smoothstep(((Port_Value_N061+0.001)-0.001)+strokeThickness,strokeThickness,l9_10);
...
if (l9_13&&(27==PreviewNodeID))
{
PreviewInfo.Saved=true;
PreviewInfo.Color=vec4(l9_11,l9_11,l9_11,1.0);
PreviewInfo.Color.w=1.0;
}
l9_4=mix(l9_6,strokeColor,vec4(l9_11));
}
#else
{
vec4 l9_14;
Node70_If_else(0.0,vec4(1.0),vec4(0.0),l9_14,l9_3);
l9_4=l9_14;
}
#endif
...
{
l9_17=clamp(l9_4.w*2.0,0.0,1.0);
}
#else
{
float l9_18;
...
{
l9_18=clamp(dot(l9_4.xyz,vec3(l9_4.w)),0.0,1.0);
}
#else
{
float l9_19;
...
{
l9_20=(1.0-dot(l9_4.xyz,vec3(0.33333001)))*l9_4.w;
}
#else
{
float l9_21;
...
{
l9_21=(1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0))*l9_4.w;
}
#else
{
float l9_22;
...
{
l9_22=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_4.w;
}
#else
{
float l9_23;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_24=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_4.w;
}
#else
{
float l9_25;
...
{
l9_25=dot(l9_4.xyz,vec3(0.33333001))*l9_4.w;
}
#else
{
float l9_26;
#if (sc_BlendMode_Min)
{
l9_26=1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_27;
...
#endif
l9_15=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_4.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_16);
}
#else
{
vec4 l9_28;
...
#endif
l9_30=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_34,sc_ScreenTextureLayout,l9_35).xy,0.0);
}
#endif
vec4 l9_36;
...
#endif
vec3 l9_38=mix(l9_36.xyz,definedBlend(l9_36.xyz,l9_4.xyz).xyz,vec3(l9_4.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_40=vec4(mix(vec3(1.0),l9_4.xyz,vec3(l9_4.w)),l9_4.w);
}
#else
{
vec4 l9_41;
...
#endif
l9_41=vec4(l9_4.xyz*l9_42,l9_42);
}
#else
{
l9_41=l9_4;
