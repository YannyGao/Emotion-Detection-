...
//spec_const bool uv2EnableAnimation 79
//spec_const bool uv3EnableAnimation 80
//spec_const int NODE_13_DROPLIST_ITEM 81
//spec_const int NODE_27_DROPLIST_ITEM 82
//spec_const int NODE_49_DROPLIST_ITEM 83
//spec_const int NODE_69_DROPLIST_ITEM 84
...
l9_625=l9_533.x;
float l9_626=0.0;
float l9_627=(*sc_set0.UserUniforms).opacityMul;
l9_626=l9_627;
float l9_628=0.0;
l9_628=l9_626;
float l9_629=0.0;
...
bool l9_633=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_633)
{
...
float l9_638=l9_637;
float l9_639=l9_638;
float l9_640=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_639;
float3 l9_641=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_635.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_647.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_650=l9_649.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
float l9_687=l9_679;
float4 l9_688=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_686,bias(l9_687));
...
float3 l9_698=definedBlend(l9_696,l9_697,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_706=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_706=float4(0.0);
...
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_708.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
